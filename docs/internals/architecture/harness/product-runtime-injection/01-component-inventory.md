...
| Prompt | `harness.capabilities.prompt` | ordered-many | Planned | section composition and templates |
| Skill | `harness.resources` plus Product selection | ordered-many | Planned | descriptor, discovery, resource overlay |
...
| Tool pack | `harness.capabilities.tools` / `harness.tools` | ordered-many | Planned | activation, contributions, workspace packs |
| Command pack | `harness.capabilities.commands` | ordered-many | Planned | catalog, conflict resolution, dispatch |
