...
def take_over_stdout(*, stdout: TextIO | None = None, stderr: TextIO | None = None) -> bool:
    """Route incidental stdout writes to stderr while preserving a raw stdout handle."""
    global _state
...
@contextmanager
def stdout_guard(*, stdout: TextIO | None = None, stderr: TextIO | None = None) -> Iterator[None]:
