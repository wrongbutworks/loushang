...
from loushang.ai.types import AssistantMessage, UsageObservation
...
def usage_observation_from_message(
    message: AssistantMessage,
) -> UsageObservation:
    return message.usage


def usage_observation_payload(usage: UsageObservation | None) -> dict[str, object]:
    if usage is None:
        return {
            "present": False,
            "input": None,
