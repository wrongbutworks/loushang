...
_EXPORT_MODULES = {
    ...
    "project_runtime_event_to_json_views": "loushang.harness.events.runtime_views",
    "shape_runtime_event_view": "loushang.harness.events.runtime_views",
    "should_emit_runtime_event_view": "loushang.harness.events.runtime_views",
    ...
    "AgentSessionEvent": "loushang.harness.events.session_types",
    "QueueUpdateEvent": "loushang.harness.events.session_types",
    "CompactionStartEvent": "loushang.harness.events.session_types",
    "CompactionEndEvent": "loushang.harness.events.session_types",
    "AutoRetryStartEvent": "loushang.harness.events.session_types",
    "AutoRetryEndEvent": "loushang.harness.events.session_types",
    "BranchSummaryStartEvent": "loushang.harness.events.session_types",
    "BranchSummaryEndEvent": "loushang.harness.events.session_types",
    "SessionInfoChangedEvent": "loushang.harness.events.session_types",
    "PackageProgressSessionEvent": "loushang.harness.events.session_types",
    "ToolPolicyAuditSessionEvent": "loushang.harness.events.session_types",
    "JsonEventView": "loushang.harness.events.session_projection",
    "SUPPORTED_JSON_EVENT_VIEWS": "loushang.harness.events.session_projection",
    "SessionEvent": "loushang.harness.events.session_projection",
    ...
    "project_session_event": "loushang.harness.events.session_projection",
    "select_events": "loushang.harness.events.session_projection",
    "should_emit_projected_event": "loushang.harness.events.session_projection",
    "shape_stream_event": "loushang.harness.events.session_projection",
